 ...
 */
export const MATRIX: Record<PermissionKey, readonly ['YES' | 'ASSIGNED' | 'NO', 'YES' | 'ASSIGNED' | 'NO']> = {
...
export const ROUTES: Partial<
  Record<PermissionKey, { method: 'get' | 'post' | 'put' | 'patch' | 'delete'; path: (ids: { managerId: string }) => string; body?: unknown }>
> = {
