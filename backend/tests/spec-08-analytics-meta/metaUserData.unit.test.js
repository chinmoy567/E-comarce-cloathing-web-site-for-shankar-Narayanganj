...
describe('Meta user data hashing (spec 08 §6.5)', () => {
    it('hashes email with normalization (lowercase, trim)', () => {
        ...
        expect(result.em).toBe('c0c8ef6a62ad65ec9fc7b3f1bfe51e3c4c08c73ccc73bdd3c20e13a7f3ca5f1d');
        // No plain-text value
    ...
    it('hashes phone with digits-only normalization', () => {
        ...
        expect(result.ph).toBe('9ec3c4f3c61cf4b9f9a3cea37f3b4a3dcf8f2c0c9e0d3e7f8b7c2a8e4f6d1a');
    });
