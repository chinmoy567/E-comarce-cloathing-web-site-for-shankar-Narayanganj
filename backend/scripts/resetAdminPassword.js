...
async function main() {
    ...
    try {
        ...
        const { rows } = await client.query(`UPDATE users SET password_hash = $1, must_change_password = true
        ...
        await client.query(`INSERT INTO audit_logs (entity_type, entity_id, action, actor_type)
       VALUES ('user', $1, 'OUT_OF_BAND_ADMIN_RESET', 'SYSTEM')`, [adminId]);
